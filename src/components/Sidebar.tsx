...
import { MessageCircle, BookOpen, Calendar, Users, Home, X } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isMobileMenuOpen, setIsMobileMenuOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 h-full w-80 bg-white/95 backdrop-blur-md border-r border-gray-200 shadow-lg z-50
      ...
      <nav className="p-6">
        ...
        <div className="lg:hidden mt-8 pt-6 border-t border-gray-200">
          <button 
            onClick={closeMobileMenu}
            className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-all duration-200 shadow-md hover:shadow-lg"
          >
